...
def test_extension_api_020_is_exactly_pinned_by_host_packages():
    ...
    assert extension_project["project"]["version"] == "0.2.0"
    assert "deerflow-extension-api==0.2.0" in harness_project["project"]["dependencies"]
    assert "deerflow-extension-api==0.2.0" in application_project["project"]["dependencies"]
