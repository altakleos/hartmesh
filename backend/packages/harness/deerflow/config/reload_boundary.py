...
STARTUP_ONLY_FIELDS: dict[str, str] = {
    ...
    "deployment": ("the Gateway validates its durability promise against the authoritative invocation store once during startup; profile changes require a restart."),
