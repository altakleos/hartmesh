...
STARTUP_ONLY_FIELDS: dict[str, str] = {
    ...
    "required_capabilities": ("trusted capability requirements are validated once while the Gateway application is constructed; changes require a restart."),
    ...
    "deployment": ("the Gateway resolves the server-owned tenant identity and validates its durability promise once during application construction; tenant/profile changes require a restart."),
