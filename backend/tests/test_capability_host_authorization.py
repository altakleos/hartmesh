...
def test_extension_api_030_is_exactly_pinned_by_host_packages():
    ...
    assert extension_project["project"]["version"] == "0.3.0"
    assert "deerflow-extension-api==0.3.0" in harness_project["project"]["dependencies"]
    assert "deerflow-extension-api==0.3.0" in application_project["project"]["dependencies"]
