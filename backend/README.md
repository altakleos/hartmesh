...
`0011_mcp_tasks` through HartMesh's `0019_inbound_event_identity` tail and
upstream's `0012_mcp_task_results` branch to the single
`0020_merge_mcp_task_results` head. It checks exact
