...
How checkpointer storage represents `messages`, how the two modes are frozen and
gated, and what the runtime does instead of forking in `delta` mode.

For the high-level orientation and the rules you must not discover the hard way,
see [`runtime/AGENTS.md`](../packages/harness/deerflow/runtime/AGENTS.md) →
...
## Fork linearization in delta mode
...
see [`runs/AGENTS.md`](../packages/harness/deerflow/runtime/runs/AGENTS.md).

## Targeted run-event attribution
...
See also [`runtime/AGENTS.md`](../packages/harness/deerflow/runtime/AGENTS.md) and [`runs/AGENTS.md`](../packages/harness/deerflow/runtime/runs/AGENTS.md).
