...
| **Product** (`/api/product`) | `GET /` - the product's name (`ui.product_name`, HartMesh when unset). Public, because the sign-in page and every tab title carry it; the tenant bundle's brand stays behind sign-in |
