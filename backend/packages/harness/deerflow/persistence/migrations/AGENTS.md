...
- `migrations/versions/0021_merge_managed_subagents.py` — no-op merge of the published HartMesh head and upstream's managed-subagent branch; it is the one current head
