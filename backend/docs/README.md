...
| [RUNTIME_INVARIANTS.md](RUNTIME_INVARIANTS.md) | The backend runtime's rules in full: admission, fencing, evidence, sandbox sessions, scheduling, and governance |
| [RUN_MANAGER_CONTRACT.md](RUN_MANAGER_CONTRACT.md) | How Gateway admits, owns, cancels, and recovers runs: leases, takeover, reservations, and stream recovery |
...
├── RUNTIME_INVARIANTS.md      # Backend runtime rules in full
├── RUN_MANAGER_CONTRACT.md    # Run admission, ownership, recovery
